...
Line 29:11 Transforming let to the configured target environment ("es5") is not supported yet
Line 29:19 Transforming for-of loops to the configured target environment ("es5") is not supported yet
Line 41:43 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 117:39 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 245:64 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 283:42 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 432:38 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 508:39 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 570:41 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 720:42 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
  ...
  (() => {
    ...
    document.body.addEventListener("touchstart", function(e) {
      ...
      if (flickitySliderElement) {
        ...
        console.log(import_flickity_fade);
